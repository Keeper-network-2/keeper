...
require (
	...
	github.com/Layr-Labs/incredible-squaring-avs v0.0.0-20240514045747-90d3254784d9
...
replace github.com/Layr-Labs/eigensdk-go => github.com/Layr-Labs/eigensdk-go v0.1.9
